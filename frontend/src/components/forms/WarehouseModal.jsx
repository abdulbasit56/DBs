// components/forms/WarehouseModal.jsx
import React, { useState } from 'react';
import { XMarkIcon } from '@heroicons/react/24/outline';
import { api } from '../../services/api';

const WarehouseModal = ({ showModal, setShowModal, onWarehouseCreated }) => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const newWarehouse = await api.post('/api/warehouses', formData);
      ...
      <div className="relative w-full max-w-md">
        <div className="bg-white rounded-xl shadow-xl border border-gray-800 overflow-hidden" onClick={e => e.stopPropagation()}>
          ...
          <div className="flex justify-between items-center p-5 border-b border-gray-800">
            <h3 className="text-xl font-bold text-gray-800">Create New Warehouse</h3>
            <button 
